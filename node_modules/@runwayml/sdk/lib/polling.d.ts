...
import { WorkflowInvocationRetrieveResponse } from "../resources/workflow-invocations.js";
...
export declare class WorkflowInvocationFailedError extends Error {
    invocationDetails: WorkflowInvocationRetrieveResponse;
    constructor(invocationDetails: WorkflowInvocationRetrieveResponse.Failed | WorkflowInvocationRetrieveResponse.Cancelled);
}
export declare class WorkflowInvocationTimedOutError extends Error {
    invocationDetails: WorkflowInvocationRetrieveResponse;
...
export type APIPromiseWithAwaitableWorkflowInvocation<T extends {
    id: string;
}> = APIPromise<T> & {
    /**
     ...
     */
    waitForTaskOutput: (options?: WaitForTaskOutputOptions) => Promise<WorkflowInvocationRetrieveResponse.Succeeded>;
};
export declare function wrapAsWaitableWorkflowInvocation<T extends {
    id: string;
}>(client: RunwayML): (responsePromise: APIPromise<T>, skipInitialWait?: boolean) => APIPromiseWithAwaitableWorkflowInvocation<T>;
