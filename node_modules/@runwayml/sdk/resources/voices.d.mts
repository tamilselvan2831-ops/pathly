...
export declare class Voices extends APIResource {
     ...
     */
    update(id: string, body?: VoiceUpdateParams | null | undefined, options?: RequestOptions): APIPromise<VoiceUpdateResponse>;
    /**
 ...
 * A voice that is still being processed.
 */
export type VoiceUpdateResponse = VoiceUpdateResponse.Processing | VoiceUpdateResponse.Ready | VoiceUpdateResponse.Failed;
export declare namespace VoiceUpdateResponse {
    /**
     * A voice that is still being processed.
     */
    interface Processing {
