...
import { AuditLogListParams, AuditLogListResponse, AuditLogListResponsesCursorPage, AuditLogRetrieveParams, AuditLogRetrieveResponse, AuditLogs } from "./audit-logs.mjs";
import { CursorPage, type CursorPageParams, PagePromise } from "../../../core/pagination.mjs";
import { RequestOptions } from "../../../internal/request-options.mjs";
export declare class Webapp extends APIResource {
     ...
     */
    listUsage(query: WebappListUsageParams, options?: RequestOptions): PagePromise<WebappListUsageResponsesCursorPage, WebappListUsageResponse>;
}
...
export declare namespace Webapp {
    export { type WebappListUsageResponse as WebappListUsageResponse, type WebappListUsageResponsesCursorPage as WebappListUsageResponsesCursorPage, type WebappListUsageParams as WebappListUsageParams, };
    export { AuditLogs as AuditLogs, type AuditLogRetrieveResponse as AuditLogRetrieveResponse, type AuditLogListResponse as AuditLogListResponse, type AuditLogListResponsesCursorPage as AuditLogListResponsesCursorPage, type AuditLogRetrieveParams as AuditLogRetrieveParams, type AuditLogListParams as AuditLogListParams, };
}
//# sourceMappingURL=webapp.d.mts.map