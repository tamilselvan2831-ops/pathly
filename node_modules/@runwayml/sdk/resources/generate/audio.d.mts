...
export declare class Audio extends APIResource {
     ...
     */
    create(body: AudioCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<AudioCreateResponse>;
}
/**
...
export declare namespace AudioCreateResponse {
    /**
     * Metadata describing which model the router selected and why.
     */
    interface Routing {
...
export declare namespace Audio {
    export { type ReferenceVoice as ReferenceVoice, type ReferenceAudio as ReferenceAudio, type AudioCreateResponse as AudioCreateResponse, type AudioCreateParams as AudioCreateParams, };
}
