 ...
 */
export declare class ImageUpscale extends APIResource {
    /**
...
export declare namespace ImageUpscaleCreateResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace ImageUpscale {
    export { type ImageUpscaleCreateResponse as ImageUpscaleCreateResponse, type ImageUpscaleCreateParams as ImageUpscaleCreateParams, };
}
//# sourceMappingURL=image-upscale.d.mts.map