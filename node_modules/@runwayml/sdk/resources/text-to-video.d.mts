...
export declare namespace TextToVideoCreateResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export type TextToVideoCreateParams = TextToVideoCreateParams.Gen4_5 | TextToVideoCreateParams.Veo3_1 | TextToVideoCreateParams.Veo3_1Fast | TextToVideoCreateParams.Hailuo3 | TextToVideoCreateParams.Happyhorse1_0 | TextToVideoCreateParams.Seedance2 | TextToVideoCreateParams.Seedance2Fast | TextToVideoCreateParams.Seedance2Mini | TextToVideoCreateParams.GeminiOmniFlash | TextToVideoCreateParams.Seedance2_5 | TextToVideoCreateParams.GrokImagine1_5 | TextToVideoCreateParams.Wan3;
export declare namespace TextToVideoCreateParams {
    ...
    interface Happyhorse1_0 {
         ...
         * The resolution of the output video.
         */
        ratio?: '1280:720' | '720:1280' | '960:960' | '1108:832' | '832:1108' | '1920:1080' | '1080:1920' | '1440:1440' | '1662:1248' | '1248:1662';
    }
    interface Seedance2 {
        model: 'seedance2';
        /**
    ...
    interface Seedance2_5 {
         ...
         */
        ratio?: '992:432' | '854:480' | '752:560' | '640:640' | '560:752' | '480:854' | '1470:630' | '1280:720' | '1112:834' | '960:960' | '834:1112' | '720:1280' | '2206:946' | '1920:1080' | '1664:1248' | '1440:1440' | '1248:1664' | '1080:1920';
        /**
    ...
    interface Wan3 {
         ...
         */
        ratio?: '832:480' | '640:480' | '480:480' | '480:640' | '480:832' | '1280:720' | '960:720' | '720:720' | '720:960' | '720:1280' | '1920:1080' | '1440:1080' | '1080:1080' | '1080:1440' | '1080:1920' | 'auto_480p' | 'auto_720p' | 'auto_1080p';
        /**
         * An optional array of audio references. The total combined duration must not
         * exceed 15 seconds.
         */
