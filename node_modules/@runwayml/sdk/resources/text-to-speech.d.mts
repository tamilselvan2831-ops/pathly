...
export declare namespace TextToSpeechCreateResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export type TextToSpeechCreateParams = TextToSpeechCreateParams.SeedAudio | TextToSpeechCreateParams.ElevenMultilingualV2 | TextToSpeechCreateParams.ElevenV3;
export declare namespace TextToSpeechCreateParams {
    ...
    namespace ElevenMultilingualV2 {
        /**
         * A voice preset from the RunwayML API.
         */
        interface Voice {
