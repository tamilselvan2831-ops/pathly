...
import { AvatarConversations, } from "./resources/avatar-conversations.mjs";
...
import { ImageUpscale, } from "./resources/image-upscale.mjs";
import { RealtimeSessions, } from "./resources/realtime-sessions.mjs";
import { Recipes, } from "./resources/recipes.mjs";
import { Routers, } from "./resources/routers.mjs";
...
import { VideoToHdr } from "./resources/video-to-hdr.mjs";
...
import { Generate } from "./resources/generate/generate.mjs";
    ...
    buildBody({ options }) {
        ...
        if (!body) {
            ...
            if (body == null && 'body' in options) {
                return __classPrivateFieldGet(this, _RunwayML_encoder, "f").call(this, { body, headers: buildHeaders([rawHeaders]) });
            }
