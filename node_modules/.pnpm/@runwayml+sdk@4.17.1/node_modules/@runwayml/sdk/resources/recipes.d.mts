...
export declare class Recipes extends APIResource {
    /**
     * Localize an existing ad image for a target language, preserving visual creative
     * while adapting on-screen messaging.
     */
    adLocalization(body: RecipeAdLocalizationParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeAdLocalizationResponse>;
    /**
     * Generate a polished marketing stock image from a text brief and optional brand
     * logo image.
     */
    marketingStockImage(body: RecipeMarketingStockImageParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeMarketingStockImageResponse>;
    /**
     * Generate a multi-cut video from a story prompt (auto mode) or a custom shot list
     * (custom mode).
     */
    multiShotVideo(body: RecipeMultiShotVideoParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeMultiShotVideoResponse>;
    /**
     * Generate a cinematic product ad from product images, optional style references,
     * product info, and creative direction.
     */
    productAd(body: RecipeProductAdParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeProductAdResponse>;
    /**
     * Generate four fashion campaign images from a product image and style brief.
     */
    productCampaignImage(body: RecipeProductCampaignImageParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeProductCampaignImageResponse>;
    /**
     * Replace the product in a reference video with a new product, preserving camera
     * motion, lighting, and scene composition.
     */
    productSwap(body: RecipeProductSwapParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeProductSwapResponse>;
    /**
     ...
     */
    productUgc(body: RecipeProductUgcParams, options?: RequestOptions): APIPromiseWithAwaitableTask<RecipeProductUgcResponse>;
}
...
export declare namespace RecipeAdLocalizationResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace RecipeMarketingStockImageResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace RecipeMultiShotVideoResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace RecipeProductAdResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace RecipeProductCampaignImageResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace RecipeProductSwapResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace RecipeProductUgcResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export interface RecipeAdLocalizationParams {
     ...
     */
    targetLanguage: 'ar' | 'zh' | 'zh-Hant' | 'nl' | 'en' | 'fr' | 'de' | 'hi' | 'id' | 'it' | 'ja' | 'ko' | 'pl' | 'pt' | 'ru' | 'es' | 'sv' | 'th' | 'tr' | 'uk' | 'vi' | 'el';
    /**
...
export declare namespace RecipeAdLocalizationParams {
    /**
     * Reference ad image to localize. See [our docs](/assets/inputs#images) on image
     * inputs.
     */
...
export declare namespace RecipeMarketingStockImageParams {
    /**
     * Optional brand logo image to guide the generated marketing stock image. See
     * [our docs](/assets/inputs#images) on image inputs.
     */
...
export type RecipeMultiShotVideoParams = RecipeMultiShotVideoParams.Variant0 | RecipeMultiShotVideoParams.Variant1;
...
export declare namespace RecipeProductAdParams {
...
export declare namespace RecipeProductCampaignImageParams {
    /**
     * Product image to preserve across the generated campaign. See
     * [our docs](/assets/inputs#images) on image inputs.
     */
...
export declare namespace RecipeProductSwapParams {
     ...
     * [our docs](/assets/inputs#images) on image inputs.
     */
    interface OriginalProductImage {
        /**
         * A HTTPS URL, Runway upload URI, or base64 data URI (e.g.
         * `data:image/png;base64,...`, up to 5MB) containing an encoded image. See
         * [our docs](/assets/inputs#images) on image inputs for more information.
...
export declare namespace RecipeProductUgcParams {
    /**
     * Image of the character who will appear on camera in the UGC video. Aspect ratio
     * (width / height) must be between 0.4 and 4. See
     * [our docs](/assets/inputs#images) for image input requirements.
