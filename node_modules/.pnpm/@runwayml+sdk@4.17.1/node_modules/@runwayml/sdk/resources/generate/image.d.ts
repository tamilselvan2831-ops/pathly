...
export declare class Image extends APIResource {
    /**
     * Start an image generation task using a saved Model Router config instead of
     * naming a model.
     */
    create(body: ImageCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<ImageCreateResponse>;
}
...
export declare namespace ImageCreateResponse {
    /**
     * Metadata describing which model the router selected and why.
     */
    interface Routing {
