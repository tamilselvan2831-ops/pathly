...
export declare class AvatarConversations extends APIResource {
    /**
     ...
     */
    list(query: AvatarConversationListParams, options?: RequestOptions): PagePromise<AvatarConversationListResponsesCursorPage, AvatarConversationListResponse>;
    /**
 ...
 */
export type AvatarConversationRetrieveResponse = AvatarConversationRetrieveResponse.InProgress | AvatarConversationRetrieveResponse.Ended | AvatarConversationRetrieveResponse.Failed;
export declare namespace AvatarConversationRetrieveResponse {
    /**
     * A conversation that is currently active.
     */
...
export declare namespace AvatarConversationListResponse {
    /**
     * A preset avatar.
     */
    interface RunwayPreset {
...
export declare namespace AvatarConversations {
    export { type AvatarConversationRetrieveResponse as AvatarConversationRetrieveResponse, type AvatarConversationListResponse as AvatarConversationListResponse, type AvatarConversationListResponsesCursorPage as AvatarConversationListResponsesCursorPage, type AvatarConversationListParams as AvatarConversationListParams, };
}
//# sourceMappingURL=avatar-conversations.d.mts.map