 ...
 */
export declare class VideoToHdr extends APIResource {
    /**
     ...
     * ```
     */
    create(body: VideoToHdrCreateParams, options?: RequestOptions): APIPromiseWithAwaitableTask<VideoToHdrCreateResponse>;
}
...
export declare namespace VideoToHdrCreateResponse {
    /**
     * The maximum credits this task may charge. The final amount may be lower after
     * the task completes.
     */
...
export declare namespace VideoToHdr {
    export { type VideoToHdrCreateResponse as VideoToHdrCreateResponse, type VideoToHdrCreateParams as VideoToHdrCreateParams, };
}
//# sourceMappingURL=video-to-hdr.d.mts.map