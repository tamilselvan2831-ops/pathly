...
export declare class AuditLogs extends APIResource {
     ...
     */
    retrieve(eventID: string, query?: AuditLogRetrieveParams | null | undefined, options?: RequestOptions): APIPromise<AuditLogRetrieveResponse>;
    /**
     ...
     * workspace.
     */
    list(query: AuditLogListParams, options?: RequestOptions): PagePromise<AuditLogListResponsesCursorPage, AuditLogListResponse>;
}
...
export declare namespace AuditLogRetrieveResponse {
    /**
     * Action-specific details.
     */
    interface Metadata {
...
export declare namespace AuditLogs {
    export { type AuditLogRetrieveResponse as AuditLogRetrieveResponse, type AuditLogListResponse as AuditLogListResponse, type AuditLogListResponsesCursorPage as AuditLogListResponsesCursorPage, type AuditLogRetrieveParams as AuditLogRetrieveParams, type AuditLogListParams as AuditLogListParams, };
}
