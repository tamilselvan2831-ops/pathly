...
const WebappAPI = tslib_1.__importStar(require("./webapp/webapp.js"));
const webapp_1 = require("./webapp/webapp.js");
class Organization extends resource_1.APIResource {
    constructor() {
        super(...arguments);
        this.webapp = new WebappAPI.Webapp(this._client);
    }
    /**
...
Organization.Webapp = webapp_1.Webapp;
