...
import * as WebappAPI from "./webapp/webapp.mjs";
import { Webapp, WebappListUsageParams, WebappListUsageResponse, WebappListUsageResponsesCursorPage } from "./webapp/webapp.mjs";
import { APIPromise } from "../../core/api-promise.mjs";
import { RequestOptions } from "../../internal/request-options.mjs";
export declare class Organization extends APIResource {
    webapp: WebappAPI.Webapp;
    /**
...
export declare namespace OrganizationRetrieveUsageResponse {
    ...
    interface ResultsByAPIKey {
        date: string;
        usedCredits: Array<ResultsByAPIKey.UsedCredit>;
    }
    namespace ResultsByAPIKey {
        interface UsedCredit {
            amount: number;
            apiKeyId: string;
        }
...
export declare namespace Organization {
    ...
    export { Webapp as Webapp, type WebappListUsageResponse as WebappListUsageResponse, type WebappListUsageResponsesCursorPage as WebappListUsageResponsesCursorPage, type WebappListUsageParams as WebappListUsageParams, };
}
