...
exports.WorkflowInvocationTimedOutError = exports.WorkflowInvocationFailedError = exports.AbortError = exports.TaskTimedOutError = exports.TaskFailedError = void 0;
exports.wrapAsWaitableResource = wrapAsWaitableResource;
exports.wrapAsWaitableWorkflowInvocation = wrapAsWaitableWorkflowInvocation;
...
class WorkflowInvocationFailedError extends Error {
    constructor(invocationDetails) {
...
exports.WorkflowInvocationFailedError = WorkflowInvocationFailedError;
class WorkflowInvocationTimedOutError extends Error {
    constructor(invocationDetails) {
...
exports.WorkflowInvocationTimedOutError = WorkflowInvocationTimedOutError;
...
function wrapAsWaitableWorkflowInvocation(client) {
    return (responsePromise, skipInitialWait = false) => {
        return Object.defineProperty(responsePromise, 'waitForTaskOutput', {
            value: async (options) => {
                const wait = () => new Promise((resolve) => setTimeout(resolve, POLL_TIME + Math.random() * POLL_JITTER - POLL_JITTER / 2));
